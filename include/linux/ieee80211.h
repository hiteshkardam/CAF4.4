...
#define WLAN_AKM_SUITE_FT_8021X     (0x000FAC, 3)
#define WLAN_AKM_SUITE_FT_PSK       (0x000FAC, 4)
...
#define WLAN_CIPHER_SUITE_PMK       (0x00904C, 0)

#define WLAN_AKM_SUITE_WAPI_PSK         (0x000FAC, 13)
#define WLAN_AKM_SUITE_WAPI_CERT        (0x000FAC, 14)
